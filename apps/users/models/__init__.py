...
class User(AbstractUser):
    ...
    # 开发者特权（users.0002 迁移）
    is_developer = models.BooleanField("开发者特权", default=False)
    developer_note = models.CharField("特权说明", max_length=255, blank=True, default="")
    developer_expires = models.DateTimeField("特权到期时间", null=True, blank=True)
