...
INDUSTRY_LIBRARY = {
    ...
    "法律行业": {
        "mainWords": ["婚姻家庭", "刑事辩护", "交通事故", "劳动仲裁", "合同纠纷", "知识产权", "房产纠纷", "债权债务", "公司法务", "侵权赔偿"],
        "longTailWords": [
            "离婚财产怎么分割", "刑事辩护律师费用", "交通事故赔偿标准",
            "劳动仲裁怎么申请", "合同纠纷如何起诉", "商标被侵权怎么办",
            "二手房买卖纠纷", "欠钱不还怎么起诉", "公司股权纠纷律师",
            "人身损害怎么赔偿",
        ],
        "negativeWords": ["法考培训", "司法考试", "法条背诵", "考研资料", "公开课", "法学生求职", "律所招聘", "法学论文"],
    },
}
...
INDUSTRY_DESC = {
    ...
    "工程建材行业": "工程设备行业",
    "宠物行业": "宠物相关服务",
    "互联网服务商（代运营/软件开发）": "互联网电商行业",    "法律行业": "法律需求高利润行业",
